...
import com.didk.feign.fallback.ParamsFeignClientFallbackFactory;
 ...
 */
@FeignClient(name = ServiceConstant.didk_ADMIN_SERVER, contextId = "ParamsFeignClient", fallback = ParamsFeignClientFallbackFactory.class)
