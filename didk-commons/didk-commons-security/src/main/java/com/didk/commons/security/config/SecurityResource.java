package com.didk.commons.security.config;
...
public class SecurityResource {
    ...
    public List<String> getPermitList() {
        ...
        Resource[] resources = resolver.getResources("classpath*:didk-auth.yml");
        String key = "ignore_urls";
        System.out.println(getPropertiesList(key, resources));
